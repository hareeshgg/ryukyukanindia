...
export function UploadDropzone({
  ...
  return (
    ...
    >
      ...
      {/* Background Glow */}
      <div className="absolute inset-0 bg-linear-to-tr from-blue-500/5 via-transparent to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
