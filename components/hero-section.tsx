          ...
          <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left mb-10">
                <h1 className="mt-16 max-w-2xl text-balance text-5xl font-medium md:text-6xl xl:text-7xl">
                  RYUKYUKAN INDIA
                </h1>
              ...
              <div className="flex items-center justify-around h-56 w-full lg:items-start lg:justify-start lg:absolute lg:h-max lg:w-2/3  lg:top-50 lg:-right-70 lg:gap-18">
                <div>
            ...
            <img
              className="-z-50 ml-auto h-200 object-cover absolute inset-0 size-full opacity-25"
              src={logo.src}
              alt="Abstract Object"
              height="4000"
              width="3000"
